basicGame.outState = function(game) {
...
basicGame.outState.prototype = {

	preload: function() {

		this.load.tilemap('tilemap', 'assets/tilemaps/test2.json', null, Phaser.Tilemap.TILED_JSON);
	...
	create: function() {
		...
		player = this.add.sprite(160, 2350, 'player');
	...
	update: function() {
		...
		if (player.x > 119 && player.x < 200 && player.y > 2365) {
